-- =====================================================
-- SCRIPT PARA CRIAR BUCKETS DE STORAGE DO SISTEMA MOTOBOY
-- =====================================================
...
-- Nota: As configurações de cache são gerenciadas automaticamente pelo Supabase
-- Não é necessário configurar cache_control, avif_autodetection, webp_autodetection
-- pois essas colunas não existem na tabela storage.buckets
...
SELECT get_public_url('motoboy-documents', 'laudos/teste.pdf') as exemplo_url;
...
-- ✅ Configurações de cache aplicadas
-- 
-- Próximos passos:
